...
class HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Olá Flutter'), centerTitle: true),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Defina Quantidade: ${currentSliderValue.toInt()}',
            ...
            Row(
              ...
              children: [
                ...
                const Flexible(
                  child: Text("Sim, eu desejo receber promoções por e-mail."),
                ),
              ],
            ),
